    ...
    return (
        <div className="h-screen flex flex-col justify-center gap-20 bg-white dark:bg-orangeFox ">
            <picture className="self-center">
                ...
                />
                <img
                    src="../src/assets/images/logo-no-background.svg"
                    alt="Browser with large and small images of a coffee cup and plants"
                    className="h-[160px] w-auto"
                />
            </picture>
            {/* <img
                src="../src/assets/images/foxtrot-low-resolution-logo-white-on-transparent-background.svg"
                className="h-[160px] w-auto"
                alt="Foxtrot Logo"
            /> */}
            <div className="flex flex-col items-center gap-4" role="status">
                <p className="text-orangeFox dark:text-white text-2xl font-thin">
                    Loading
                </p>
                <svg
                    aria-hidden="true"
