...
const client = new MongoClient(`mongodb+srv://${USER}:${PASSWORD}@power-rangers.9psnhuv.mongodb.net/database`, {
    useNewUrlParser: true
});


const typeArray = ["poisonous", "slippery", "block", "snow", "animal", "insect"];
